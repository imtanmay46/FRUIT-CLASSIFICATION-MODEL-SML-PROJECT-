...
Modelling = AdaBoostClassifier(base_estimator=base_estimator, n_estimators=1000, learning_rate=0.2, random_state=True) #Accuracy on Training Data: 84.65753424657534
...
result_df.to_csv('/Users/varul18/Desktop/SML-Project/predicted_categories.csv', index=False)
